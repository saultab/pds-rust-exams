...
impl ExecutionLimiter{
    ...
    fn execute<R: Default + UnwindSafe >(&self, r: R, f: impl Fn(R) -> R + UnwindSafe + RefUnwindSafe) -> R {
...
fn very_slow_print(i: usize) -> usize {
...
fn main() {
    ...
    for i in 0..N_THREADS {
        vec_handles.push(thread::spawn({
            ...
            move||{
                execution_limiter.execute(i, very_slow_print);
            }
        }))
    }
